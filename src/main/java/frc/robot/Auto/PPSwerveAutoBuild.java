...
public class PPSwerveAutoBuild extends SequentialCommandGroup {
  public PPSwerveAutoBuild
  (
...
ArrayList<PathPlannerTrajectory> pathGroup = (ArrayList<PathPlannerTrajectory>) PathPlanner.loadPathGroup(autoPath,new PathConstraints(maxVel, maxAccel));
